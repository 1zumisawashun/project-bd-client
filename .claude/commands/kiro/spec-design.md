...
- `docs/specs/specs/$1/spec.json`, `requirements.md`, `design.md` (if exists)
- **Entire `docs/specs/steering/` directory** for complete project memory
- `docs/specs/settings/templates/specs/design.md` for document structure
- `docs/specs/settings/rules/design-principles.md` for design principles
- `docs/specs/settings/templates/specs/research.md` for discovery log structure
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `docs/specs/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `docs/specs/settings/rules/design-discovery-light.md`
...
- Create or update `docs/specs/specs/$1/research.md` using the shared template
...
- Read `docs/specs/settings/templates/specs/design.md` for structure
- Read `docs/specs/settings/rules/design-principles.md` for principles
...
1. **Status**: Confirm design document generated at `docs/specs/specs/$1/design.md`
...
**Note**: The actual design document follows `docs/specs/settings/templates/specs/design.md` structure.
...
- **User Message**: "No requirements.md found at `docs/specs/specs/$1/requirements.md`"
- **Suggested Action**: "Run `/kiro:spec-requirements $1` to generate requirements first"

**Template Missing**:

- **User Message**: "Template file missing at `docs/specs/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`docs/specs/settings/rules/design-discovery-full.md`)
...
- Review generated design at `docs/specs/specs/$1/design.md`
