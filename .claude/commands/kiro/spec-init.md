...
1. **Check Uniqueness**: Verify `docs/specs/specs/` for naming conflicts (append number suffix if needed)
2. **Create Directory**: `docs/specs/specs/[feature-name]/`
3. **Initialize Files Using Templates**:
   - Read `docs/specs/settings/templates/specs/init.json`
   - Read `docs/specs/settings/templates/specs/requirements-init.md`
...
- **Template Missing**: If template files don't exist in `docs/specs/settings/templates/specs/`, report error with specific missing file path and suggest checking repository setup
