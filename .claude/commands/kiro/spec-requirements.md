...
1. **Load Context**:
   - Read `docs/specs/specs/$1/spec.json` for language and metadata
   - Read `docs/specs/specs/$1/requirements.md` for project description
...
2. **Read Guidelines**:
   - Read `docs/specs/settings/rules/ears-format.md` for EARS syntax rules
   - Read `docs/specs/settings/templates/specs/requirements.md` for document structure
...
- Review generated requirements at `docs/specs/specs/$1/requirements.md`
