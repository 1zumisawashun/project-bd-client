...
- Read `docs/specs/specs/$1/spec.json` for metadata and phase status
- Read existing files: `requirements.md`, `design.md`, `tasks.md` (if they exist)
- Check `docs/specs/specs/$1/` directory for available files
...
- **Message**: "No spec found for `$1`. Check available specs in `docs/specs/specs/`"
...
- Shows all specs in `docs/specs/specs/` with their status
