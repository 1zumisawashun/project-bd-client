...
- `docs/specs/specs/$1/spec.json`, `requirements.md`, `design.md`
- `docs/specs/specs/$1/tasks.md` (if exists, for merge mode)
...
- Read `docs/specs/settings/rules/tasks-generation.md` for principles
- If `sequential` is **false**: Read `docs/specs/settings/rules/tasks-parallel-analysis.md` for parallel judgement criteria
- Read `docs/specs/settings/templates/specs/tasks.md` for format (supports `(P)` markers)
...
- Create/update `docs/specs/specs/$1/tasks.md`
...
1. **Status**: Confirm tasks generated at `docs/specs/specs/$1/tasks.md`
2. **Task Summary**:
...
- **User Message**: "Missing requirements.md or design.md at `docs/specs/specs/$1/`"
...
- **User Message**: "Template or rules files missing in `docs/specs/settings/`"
