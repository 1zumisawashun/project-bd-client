...
1. **Load Context**:
   ...
   - Read `docs/specs/specs/$1/requirements.md` for requirements
   - Read `docs/specs/specs/$1/design.md` for design document
...
2. **Read Review Guidelines**:
   - Read `docs/specs/settings/rules/design-review.md` for review criteria and process
