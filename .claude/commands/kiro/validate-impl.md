...
- If no history found, scan `docs/specs/specs/` for features with completed tasks `[x]`

**If feature provided** (`$1` present, `$2` empty):

- Use specified feature
- Detect all completed tasks `[x]` in `docs/specs/specs/$1/tasks.md`
...
- Read `docs/specs/specs/<feature>/spec.json` for metadata
- Read `docs/specs/specs/<feature>/requirements.md` for requirements
- Read `docs/specs/specs/<feature>/design.md` for design structure
- Read `docs/specs/specs/<feature>/tasks.md` for task list
- **Load ALL steering context**: Read entire `docs/specs/steering/` directory including:
