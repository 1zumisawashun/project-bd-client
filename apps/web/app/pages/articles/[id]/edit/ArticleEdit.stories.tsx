...
import { _MOCK_ARTICLE_PUBLIC, MOCK_ARTICLE_CATEGORIES } from "../../shared/article.mocks";
...
const Render: FC = () => {
  return <ArticleEdit article={_MOCK_ARTICLE_PUBLIC} categories={MOCK_ARTICLE_CATEGORIES} />;
};
